...
The following files in this folder are transformed from the data found at [File:CGB Bootstrap ROM tables.7z](https://tcrf.net/File:CGB_Bootstrap_ROM_tables.7z):

- `game-boy-camera-palettes.csv`
- `game-boy-color-additional-palettes.csv`

That data and therefore the data in these two files (and no other content in this repository unless otherwise noted) carries the [Attribution 3.0 Unported license](https://creativecommons.org/licenses/by/3.0/)
