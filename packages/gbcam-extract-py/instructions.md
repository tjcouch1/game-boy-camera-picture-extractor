<!-- The contents of this file go in the "Instructions" in a Claude Desktop Project -->
...
Your goal is to improve the script to increase the accuracy of the transformation. You can run tests using input files (e.g. `zelda-poster-3.jpg`) and reference files (e.g. `zelda-poster-output-corrected.png`) to track your progress.
